...
locals {
  ...
  be_security_rules = {
    "Open80In"   = { security_rule_priority = 1000, security_rule_direction = "Inbound", security_rule_access = "Allow", security_rule_protocol = "Tcp", security_rule_source_port_range = "*", security_rule_destination_port_range = "80", security_rule_source_address_prefix = "*", security_rule_destination_address_prefix = "*" },
    "Open81In"   = { security_rule_priority = 1100, security_rule_direction = "Inbound", security_rule_access = "Allow", security_rule_protocol = "Tcp", security_rule_source_port_range = "*", security_rule_destination_port_range = "81", security_rule_source_address_prefix = "*", security_rule_destination_address_prefix = "*" },
    ...
    "Open444In"  = { security_rule_priority = 1120, security_rule_direction = "Inbound", security_rule_access = "Allow", security_rule_protocol = "Tcp", security_rule_source_port_range = "*", security_rule_destination_port_range = "444", security_rule_source_address_prefix = "*", security_rule_destination_address_prefix = "*" },
