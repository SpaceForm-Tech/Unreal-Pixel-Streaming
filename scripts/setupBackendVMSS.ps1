...
New-NetFirewallRule -DisplayName 'Matchmaker-IB-81' -Direction Inbound -Action Allow -Protocol TCP -LocalPort 81
New-NetFirewallRule -DisplayName 'Matchmaker-IB-82' -Direction Inbound -Action Allow -Protocol TCP -LocalPort 82
New-NetFirewallRule -DisplayName 'Matchmaker-IB-83' -Direction Inbound -Action Allow -Protocol TCP -LocalPort 83
...
New-NetFirewallRule -DisplayName 'Matchmaker-OB-81' -Direction Outbound -Action Allow -Protocol TCP -LocalPort 81
New-NetFirewallRule -DisplayName 'Matchmaker-OB-82' -Direction Outbound -Action Allow -Protocol TCP -LocalPort 82
New-NetFirewallRule -DisplayName 'Matchmaker-OB-83' -Direction Outbound -Action Allow -Protocol TCP -LocalPort 83
